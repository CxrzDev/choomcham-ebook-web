        ...
        <>
            ...
            <div className=" z-10 top-0 w-full flex justify-around glass sticky  " id="nav">
                ...
                <div className={"navbar px-10 sm:px-20  "}>
                    ...
                    <div className="navbar-center md:flex  gap-10 hidden ">
                        <ul className=' gap-5 hidden font-medium md:flex items-center'>
                            ...
                            <li className="transform hover:-translate-y-0.5 duration-200">
                                <a className={'bg-[--green] text-white hover:bg-[#138f75]  rounded-full px-6 py-2 shadow-lg hover:shadow-xl block'} href="/quiz">
                                    ทำแบบสอบถาม
                                </a>
                            </li>
                    ...
                    <button className="btn btn-ghost btn-circle">
                        ...
                        <div className="drawer-content flex items-center justify-center">
                            {/* Page content here */}
                            <label htmlFor="my-drawer" className="drawer-button btn-ghost p-2 duration-150 rounded-md block md:hidden">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 12h16M4 18h7" /></svg>
                            </label>
                        </div>
                        <div className="drawer-side">
                            ...
                            <ul className="menu p-4 w-80 min-h-full bg-base-200 text-base-content">
                                ...
                                <li><a href="/">Home</a></li>
                                <li><a href="/courses/3ms">3 Minutes Story</a></li>
                                ...
                                <div className="grid gap-2 grid-flow-col items-center">
                                    <Button as="a" target="_blank" href="https://lin.ee/5p0JD5t" isIconOnly={true} className="min-w-0 w-10 h-10 p-0">
                                    ...
                                    <Button as="a" target="_blank" href="https://youtube.com/channel/UCqiaFEL0g1TAFiK_x7acvRw" isIconOnly={true} className="min-w-0 w-10 h-10 p-0">
                                    ...
                                    <Button as="a" target="_blank" href="https://facebook.com/choomchambranding" isIconOnly={true} className="min-w-0 w-10 h-10 p-0">
                                    ...
                                    <Button as="a" target="_blank" href="tel:0829429446" className="min-w-0">082-9429446</Button>
                                </div>
                            </ul>
                        </div>
                    </div>
